...
public class BiomeGrassBlock extends TreeModElements.ModElement {
	@ObjectHolder("tree:biome_grass")
	public static final Block block = null;
	public BiomeGrassBlock(TreeModElements instance) {
		super(instance, 21);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BiomeDirtBlock.block, (int) (1)));
		}
	}
}
