...
public class ArdaniumingotItem extends TreeModElements.ModElement {
	@ObjectHolder("tree:ardaniumingot")
	public static final Item block = null;
	public ArdaniumingotItem(TreeModElements instance) {
		super(instance, 1);
	}
