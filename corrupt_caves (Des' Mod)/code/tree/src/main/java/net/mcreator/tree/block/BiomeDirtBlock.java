...
public class BiomeDirtBlock extends TreeModElements.ModElement {
	@ObjectHolder("tree:biome_dirt")
	public static final Block block = null;
	public BiomeDirtBlock(TreeModElements instance) {
		super(instance, 22);
	}
