...
public class BiomeTreeBarkBlock extends ImDumModElements.ModElement {
	@ObjectHolder("im_dum:biome_tree_bark")
	public static final Block block = null;
	public BiomeTreeBarkBlock(ImDumModElements instance) {
		super(instance, 21);
	}
