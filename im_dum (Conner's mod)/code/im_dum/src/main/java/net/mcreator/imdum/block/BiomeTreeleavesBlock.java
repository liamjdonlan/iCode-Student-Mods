...
public class BiomeTreeleavesBlock extends ImDumModElements.ModElement {
	@ObjectHolder("im_dum:biome_treeleaves")
	public static final Block block = null;
	public BiomeTreeleavesBlock(ImDumModElements instance) {
		super(instance, 22);
	}
