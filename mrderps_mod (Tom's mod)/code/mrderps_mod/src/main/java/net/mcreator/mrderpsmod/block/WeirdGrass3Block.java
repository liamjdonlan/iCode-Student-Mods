...
public class WeirdGrass3Block extends MrderpsModModElements.ModElement {
	@ObjectHolder("mrderps_mod:weird_grass_3")
	public static final Block block = null;
	public WeirdGrass3Block(MrderpsModModElements instance) {
		super(instance, 32);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("weird_grass_3"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("mrderps_mod:weird_grass_3"), configuredFeature);
		}
	}
	@SubscribeEvent
