...
public class WeirdGrassBlock extends MrderpsModModElements.ModElement {
	@ObjectHolder("mrderps_mod:weird_grass")
	public static final Block block = null;
	public WeirdGrassBlock(MrderpsModModElements instance) {
		super(instance, 29);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("weird_grass"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("mrderps_mod:weird_grass"), configuredFeature);
		}
	}
	@SubscribeEvent
