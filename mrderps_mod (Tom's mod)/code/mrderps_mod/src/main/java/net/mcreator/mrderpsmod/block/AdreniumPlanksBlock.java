...
public class AdreniumPlanksBlock extends MrderpsModModElements.ModElement {
	@ObjectHolder("mrderps_mod:adrenium_planks")
	public static final Block block = null;
	public AdreniumPlanksBlock(MrderpsModModElements instance) {
		super(instance, 40);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("adrenium_planks");
		}
