...
public class BiomeDiretBlockBlock extends MrderpsModModElements.ModElement {
	@ObjectHolder("mrderps_mod:biome_diret_block")
	public static final Block block = null;
	public BiomeDiretBlockBlock(MrderpsModModElements instance) {
		super(instance, 36);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("biome_diret_block");
		}
