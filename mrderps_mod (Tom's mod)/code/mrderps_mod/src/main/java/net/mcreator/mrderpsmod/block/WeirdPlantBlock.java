...
public class WeirdPlantBlock extends MrderpsModModElements.ModElement {
	@ObjectHolder("mrderps_mod:weird_plant")
	public static final Block block = null;
	public WeirdPlantBlock(MrderpsModModElements instance) {
		super(instance, 28);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("weird_plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("mrderps_mod:weird_plant"), configuredFeature);
		}
	}
	@SubscribeEvent
