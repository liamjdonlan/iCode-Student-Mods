...
public class GhastIngotItem extends LuckyBlockModElements.ModElement {
	@ObjectHolder("lucky_block:ghast_ingot")
	public static final Item block = null;
	public GhastIngotItem(LuckyBlockModElements instance) {
		super(instance, 1);
	}
