...
public class TreeWoodsquidBlock extends TheGoatedModModElements.ModElement {
	@ObjectHolder("the_goated_mod:tree_woodsquid")
	public static final Block block = null;
	public TreeWoodsquidBlock(TheGoatedModModElements instance) {
		super(instance, 25);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tree_woodsquid");
		}
