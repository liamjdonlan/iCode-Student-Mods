...
package net.mcreator.thegoatedmod.entity;
...
import net.mcreator.thegoatedmod.entity.renderer.CreepaBoyRenderer;
import net.mcreator.thegoatedmod.TheGoatedModModElements;

@TheGoatedModModElements.ModElement.Tag
public class CreepaBoyEntity extends TheGoatedModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.7f)).build("creepa_boy").setRegistryName("creepa_boy");
	public CreepaBoyEntity(TheGoatedModModElements instance) {
		super(instance, 36);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CreepaBoyRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("creepa_boy_spawn_egg"));
	}
