...
public class BiomeGrassBlock extends TheGoatedModModElements.ModElement {
	@ObjectHolder("the_goated_mod:biome_grass")
	public static final Block block = null;
	public BiomeGrassBlock(TheGoatedModModElements instance) {
		super(instance, 23);
	}
