...
public class PlatnumBlockBlock extends TheGoatedModModElements.ModElement {
	@ObjectHolder("the_goated_mod:platnum_block")
	public static final Block block = null;
	public PlatnumBlockBlock(TheGoatedModModElements instance) {
		super(instance, 2);
	}
